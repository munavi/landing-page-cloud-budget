...
function map(n) {
	...
	function init() {
		...
		var myMap = new ymaps.Map("map", {
			...
			// The default order: "latitude, longitude."
			// not to determine the coordinates of the card center manually,
			// Use the tool to determine the coordinates.
			controls: [],
			center: [43.585525, 39.723062],
			// The level of scaling.Permissible values:
		...
		let myPlacemark = new ymaps.Placemark([43.585525, 39.723062], {
			...
			//balloonContentBody: 'Moscow, Николоямская 40с1',
			...
			// It is necessary to specify this type of layout.
			iconLayout: 'default#imageWithContent',
			// Your image of the icon tags.
			iconImageHref: 'img/icons/map.svg',
			// The dimensions of the label.
			iconImageSize: [40, 40],
			// Displacement of the upper left corner of the icon relative to
			// Her "legs" (binding points).
			iconImageOffset: [-20, -20],
			// Displacement of the layer with the contents relative to the layer with the picture.
