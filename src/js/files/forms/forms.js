...
export function formFieldsInit(options = { viewPass: false, autoHeight: false }) {
	//If turned on, add the functionality "Hide the player choleder during focus"
	...
	// If turned on, add the functionality of "show the password"
	if (options.viewPass) {
	...
	// If turned on, add the functionality of "AutoHeight"
...
export function formSubmit() {
	...
	// Actions after sending the form
	function formSent(form, responseResult = ``) {
		...
		// Show popup, If the module popup is connected 
		// and for the form the setting is indicated
		setTimeout(() => {
			if (flsModules.popup) {
...
export function formRating() {
	...
	function initRatings() {
		...
		// "Run" on all ratings on the page
		...
		// The ability to indicate the assessment
		...
		async function setRatingValue(value, rating) {
			if (!rating.classList.contains('rating_sending')) {
				...
				if (response.ok) {
					...
					// Conclusion of a new average result
